...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  OAuthSignin: "Google 登入失敗，請稍後再試。",
  OAuthCallback: "Google 登入回呼失敗，請確認 OAuth 設定是否正確。",
  Configuration:
    "尚未設定 Google OAuth。請在 .env.local 填入 GOOGLE_CLIENT_ID 與 GOOGLE_CLIENT_SECRET 後重啟 dev server。",
  Default: "登入失敗，請稍後再試。",
};
